...
<h3 align="center">SlimeHook</h3>
  ...
  <p>
    SlimeHook is a spigot/paper plugin that utilize SlimeWorldManager/AdvancedSlimePaper for generating template world as an arena for several plugins.  <br />
    <a href="https://github.com/HappyAreaBean/SlimeHook"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <h4>
        <a href="https://github.com/HappyAreaBean/SlimeHook/release">Download from GitHub</a>
        ·
...
WIP: Will be updated when the merge of providers repo is finish.
...
1. Download SlimeHook
2. Put `SlimeHook-VERSION.jar` in your plugin folder
3. Start your server
4. After SlimeHook files is generated, you would need to configure your worlds in `worlds.yml`
...
4. Add your SWM world in `worlds.yml` or use command `/SlimeHook add`
...
See the [open issues](https://github.com/HappyAreaBean/SlimeHook/issues) for a full list of proposed features (and known issues).
